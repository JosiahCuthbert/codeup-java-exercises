...
public class Dish {
    ...
    public static void main(String[] args){
        ...
        Dish tacos = new Dish();
        tacos.costInCents = 845;
        tacos.nameOfDish = "Tacos";
        tacos.wouldRecommend = true;

        spaghetti.printSummary();
        System.out.println();

        Dish beefStew = new Dish();
        beefStew.costInCents = 625;
        beefStew.nameOfDish = "Beef Stew";
        beefStew.wouldRecommend = true;
